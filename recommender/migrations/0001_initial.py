# Generated by Django 2.1.7 on 2019-04-29 16:28
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('movie', models.ForeignKey(on_delete='SET_NULL', to='recommender.Movie')),
            ],
        ),
        migrations.CreateModel(
            name='Similarity',
            fields=[
                ...
                ('first_movie', models.ForeignKey(on_delete='SET_NULL', related_name='first_movie', to='recommender.Movie')),
                ('second_movie', models.ForeignKey(on_delete='SET_NULL', related_name='second_movie', to='recommender.Movie')),
            ],
        ),
        migrations.CreateModel(
            name='Tag',
